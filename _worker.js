...
let ipUrlTxt = [
	'https://raw.githubusercontent.com/erlkim/anu/refs/heads/main/ipv4.txt',
...
let ipLocal = [
	'visa.cn:443#youtube.com/ 订阅频道获取更多教程',
	'icook.hk#t.me/erlkim 加入交流群解锁更多优选节点',
	'time.is:443#github.com/erlkim GitHub仓库查看更多项目'
];
let noTLS = 'false';
let sl = 5;
...
function getConfigHtml(userID, host, remark, v2ray, clash) {
	...
	const htmlHead = `
    <head>
      <title>bocil-cf-tunnel(AM科技)</title>
  ...
  `;
	...
	const header = `
		...
		<a href="t.me/erlkim" target="_blank">t.me/erlkim</a>
		</br></br>
		GitHub项目地址 点击Star!Star!Star!</br>
		<a href="https://github.com/erlkim" target="_blank">https://github.com/erlkim</a>
		</br></br>
		YouTube频道,订阅频道,更多技术分享</br>
		<a href="https://youtube.com/erlkim" target="_blank">https://youtube.com/erlkim</a>
		</p>
  `;
